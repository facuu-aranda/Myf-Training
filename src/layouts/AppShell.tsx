...
export function AppShell() {
  ...
  useEffect(() => {
    ...
    const handleScroll = () => {
      ...
      if (currentScrollY <= 8 || currentScrollY < previousScrollY) setTopbarVisible(true)
      else if (currentScrollY > previousScrollY + 4) setTopbarVisible(false)
