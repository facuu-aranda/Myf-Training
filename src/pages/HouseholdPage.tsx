...
export function HouseholdPage() {
  ...
  {invitations.length > 0 && (
    <div style={{ display: 'flex', flexDirection: 'column', gap: '10px', marginBottom: '20px' }}>
      {invitations.map((inv) => (
        <GlassCard className="household-invitation" key={inv.id} style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', padding: '15px' }}>
          <div>
          ...
          <div className="household-invitation-actions" style={{ display: 'flex', gap: '10px' }}>
