...
const testRecipe: Recipe = { id: 'recipe', createdBy: null, coupleId: null, name: 'Rice', nameEs: 'Arroz', description: '', instructions: '', prepTimeMinutes: 0, cookTimeMinutes: 0, servings: 2, imageUrl: '', visibility: 'private', ingredients: [testRecipeIngredient], createdAt: '', updatedAt: '' }
